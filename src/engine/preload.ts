// Warms the browser cache for game assets so scene transitions are seamless.
// (Kept as an eager list, matching the original preload_img/preload_audio.)
...
// Only images are eagerly preloaded, so room transitions are visually seamless.
// Audio is loaded on demand (see SoundEngine) to avoid dozens of parallel,
// mostly-cancelled fetches at startup.
